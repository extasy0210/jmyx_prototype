...
function getConnection() {
	...
	global $db_jmyx_prototype_db_Url, $db_jmyx_prototype_db_User, $db_jmyx_prototype_db_Pass, $db_jmyx_prototype_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_jmyx_prototype_db_Url.";dbname=".$db_jmyx_prototype_db_DbName, $db_jmyx_prototype_db_User, $db_jmyx_prototype_db_Pass);
